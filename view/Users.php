            ...
            <ul class="nav nav-pills flex-column mb-auto">
              <li class="nav-item">
                ...
                <div class="collapse show ms-2" id="home-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    ...
                    <li><a href="Users.php" class="nav-link text-white text-decoration-none rounded ms-3 active">user</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <div class="collapse ms-2" id="report-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="Report1.php" class="nav-link text-white text-decoration-none ms-3 rounded">Laporan 1</a></li>
                    <li><a href="Report2.php" class="nav-link text-white text-decoration-none ms-3 rounded">Laporan 2</a></li>
                  </ul>
                </div>
              </li>
            </ul>
